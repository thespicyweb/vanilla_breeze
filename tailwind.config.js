...
module.exports = {
  ...
  theme: {
    ...
    columns: {
      ...
      '11': 'var(--tw-width-11)',
      '12': 'var(--tw-width-12)',
      auto: 'var(--tw-width-auto)',
      '3xs': 'var(--tw-width-3xs)',
      '2xs': 'var(--tw-width-2xs)',
      xs: 'var(--tw-width-xs)',
      sm: 'var(--tw-width-sm)',
      md: 'var(--tw-width-md)',
      lg: 'var(--tw-width-lg)',
      xl: 'var(--tw-width-xl)',
      '2xl': 'var(--tw-width-2xl)',
      '3xl': 'var(--tw-width-3xl)',
      '4xl': 'var(--tw-width-4xl)',
      '5xl': 'var(--tw-width-5xl)',
      '6xl': 'var(--tw-width-6xl)',
      '7xl': 'var(--tw-width-7xl)'
    },
    spacing: {
      '0': 'var(--tw-size-0)',
      '1': 'var(--tw-size-1)',
  ...
  plugins: [
    plugin(function ({ addComponents, theme }) {
      ...
      addComponents({
        ':root': extractVars("size-", defaultTheme.spacing),
      });
      ...
      addComponents({
        ':root': {
          '--tw-width-prose': defaultTheme.maxWidth({theme, breakpoints: () => {}}).prose
        },
      });
...
//       console.info(theme('colors'))
      ...
      //     const cssVariable = `--tw-width-${key}`;
